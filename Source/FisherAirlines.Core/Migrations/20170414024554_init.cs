    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.ConfirmationNumber);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightStatus", x => x.FlightId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingsConfirmationNumber = table.Column<int>(nullable: true),
                    DepartDate = table.Column<DateTime>(nullable: false),
                    Departure = table.Column<string>(nullable: true),
                    Destination = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BookingsConfirmationNumber,
